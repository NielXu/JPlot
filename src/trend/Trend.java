...
/**
 * Trend represent the trend of one single data on the trendgraph and each trend
...
public class Trend {
    ...
    /**
     * Construct the Trend with given category that this trend belongs to. The
     * length of the value array should be equal to the length of
