...
/**
 * SectorComponent is responsible for rendering the main chart at the center
 * 
 * @author Daniel Xu
 *
 */
public class SectorComponent extends PieComponent {
	...
	for (Sector s : sectors) {
	    ...
	    Arc2D arc = new Arc2D.Double((double) super.chart_x, (double) super.chart_y, (double) super.chart_size,
		    (double) super.chart_size, last, ratio, Arc2D.PIE);
	    g2d.fill(arc);
	    last += ratio;
	}
    }
