...
/**
 * ExceptionHandler can handle some of the common exceptions
 * in the program.
 * @author Daniel Xu
 *
 */
public class ExceptionHandler {
	...
	/**VALID_ARRAY means that the array is not null and it does not contain null element**/
	...
	/**
	 * Check if the array is null first, then check
	 * if there is any null elements in a array
	 * @param arr The array that will be checked
	 * @return {@link #VALID_ARRAY},
	 * {@link #NULL_ARRAY} or the
	 * index of the first null element in the array
	 */
	 ...
	 * if val == min or val == max, it is not
	 * considered to be out of range. If the given
	 * min is greater than max, they will be swapped
	 * to make sure to get a valid range
	...
	/**
	 * Using <code>.equals(Object) </code> to compare if
	 * the given object is equal to at least one element
	 * in the given array. This method does not handle
	 * the case that the object or array is null.
	 * @param obj The object that will be checked
	 * @param arr The array that will be compared with
	 * @return True if the object equal to least one element in the array,
	 * false otherwise
	 */
	...
	/**
	 * Using <code>==</code> to compare if
	 * the given object is equal to at least one element(instance)
	 * in the given array. This method does not handle
	 * the case that the object or array is null.
	 * @param obj The object that will be checked
	 * @param arr The array that will be compared with
