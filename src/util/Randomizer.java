...
/**
 * Randomizer provides some useful methods to get random values. Please ensure
 * that the type of random, since there are int type and double type. Randomizer
 * is static therefore no instance needed
 * 
 * @author Daniel Xu
 *
 */
public class Randomizer {
    ...
    /**
     * Get an random <b>integer</b> in range(min, max), where min and max are
     * included. If the max < min, the random inetegr will still in range(min, max)
     * 
    ...
    /**
     * Get an array of random <b>integers</b>, the integers will be in range(min,
     * max), where min and max are included.If the max < min, the random inetegrs
     * will still in range(min, max)
     * 
     * @param min      The min value, included
     * @param max      The max value, included
     * @param capacity The total capacity of the array, how many integers will be
     *                 generated
    ...
    /**
     * Get an random <b>double</b> in range(min, max), where min and max are
     * included. If the max < min, the random nunber will still in range(min, max)
     * 
     * @param min The min value, included
     * @param max The max value, included
    ...
    /**
     * Get an array of random <b>doubles</b>, the numbers will be in range(min,
     * max), where min and max are included.If the max < min, the random numbers
     * will still in range(min, max)
     * 
     * @param min      The min value, included
     * @param max      The max value, included
     * @param capacity The total capacity of the array, how many numbers will be
     *                 generated
    ...
    /**
     * Get a random point with x in range(x_min, x_max) and y in range(y_min,
     * y_max), where x_min, y_min, x_max, y_max are included. The x,y axises will be
     * in double format.
     * 
    ...
    /**
     * Get an array contains <b>point</b> with random location. x in range(x_min,
     * x_max) and y in range(y_min, y_max), where x_min, y_min, x_max, y_max are
     * included. The x,y axises of the points will be in double format.
     * 
     * @param x_min    The min vlaue of x, included
     * @param x_max    The max value of x, included
     * @param y_min    The min value of y, included
     * @param y_max    The max value of y, included
     * @param capacity The total capacity of the array, how many points will be
     *                 generated
    ...
    /**
     * Get an random <b>BigDecimal</b> in range(min, max), where min and max are
     * included. If the max < min, the random BigDecimal will still in range(min,
     * max)
     * 
     * @param min The min value, included
     * @param max The max value, included
    ...
    /**
     * Get an array of random <b>BigDecimal</b>, the numbers will be in range(min,
     * max), where min and max are included.If the max < min, the random numbers
     * will still in range(min, max)
     * 
     * @param min      The min value, included
    ...
    /**
     * Get a array that contains relative random values. It means each value in the
     * array is randomly generated by its previous value. For instance, start from
     * 10. Then the next random value will be in range (10, 10+steprange) or in
     * range (10, 10-steprange).
     * 
     * @param seed      The first value, the return array's first element will
