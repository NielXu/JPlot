...
/**
 * The configuration of the histogram. Similar to Grapher.Config, this config
 * class also many variables that can be customized, and each histogram will
 * contain one config, they will not affect each other. Please notice that this
 * Config is different from {@link grapher.Config}
 * 
 * @author Daniel Xu
 *
 */
public class Config extends BaseConfig {
    ...
    /**
     * The string array that represents the x unit on the x axis the length of the
     * array should be equal to x_max - x_min
     **/
    public String[] xunit = new String[] { "2001", "2002", "2003", "2004", "2005" };

    /**
     * The string array that represents the y unit on the y axis, the length of the
     * array should be equal to y_max - y_min. <b>The difference between each two
     * numbers should be the same</b>
     **/
    ...
    /**
     * The font that used by category label, cannot be modified for now, this also
     * controls label on TrendGraph
     **/
