...
/**
 * LayoutComponent is usually the most bottom component, it is responsible for
 * rendering labels and axis.
 * 
 * @author Daniel Xu
 *
 */
public class LayoutComponent extends HistogramComponent {
	...
	if (config.show_units_label) {
		...
		renderlabel(g, rect, config.yunit_font, String.valueOf(ylabels[yunit.length - 1 - i]),
			config.yunit_color);
	    }
	}
    }
