...
/**
 * HistogramComponent should be implemented by all components that added to the
 * HistogramPanel. The layers of component depend on the order that they are
 * being added. The first component that being added will be at the most bottom
 * layer, the last will be on the top.
 * 
 * @author Daniel Xu
 *
 */
public abstract class HistogramComponent implements Renderable {
    ...
    /**
     * Starting point of the graph, ending point of x axis and ending point of y
     * axis
     **/
