...
/**
 * Simple Histogram is a sub class of Histogram. It reduces lines
 * of codes required to construct a histogram. It do the same job
 * with Histogram. See {@link histogram.Histogram}
 * @author Daniel Xu
 *
 */
public class SimpleHistogram extends Histogram{
	...
	/**
	 * Setup the histogram by given number of sections and how many bars between
	 * one section.
	 ...
	 * The x of the array is section# and the y of the array is bar#.
	 * Modifying this array will directly affect the array in SimpleHistogram,
	 * therefore, only need to edit this array
	 * @return A two dimensional array that contains Bar for setup
	 */
	public Bar[][] setup() {
