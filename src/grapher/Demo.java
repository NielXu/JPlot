...
public class Demo {
	...
	public static Grapher funcsPointsGrapher() {
		...
		Point[] p = new Point[] { // Manually adding points on function 'x^2'
				new Point(0, 0), new Point(1, 1), new Point(-1, 1), new Point(2, 4), new Point(-2, 4), new Point(3, 9),
				new Point(-3, 9) };
		g.add_exp(e);
	 ...
	 * between two graphs. Therefore, we suggest enable high quality graph(it is
	 * enabled by default)
	 */
