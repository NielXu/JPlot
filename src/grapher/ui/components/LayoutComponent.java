...
/**
 * The layout component is the component that responsible for rendering axis,
 * grids and units. It is always at the most bottom layer, so it is the first
 * component that being added.
 * 
 * @author Daniel Xu
 *
 */
