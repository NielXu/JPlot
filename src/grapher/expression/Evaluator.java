...
/**
 * Evaluator is a power class that read string and evluate the
 * result of the string. It is a static class, therefore, no 
 * instance needed.
 * @author danielxu
 *
 */
public class Evaluator {
	 ...
	 * otherwise the result will be wrong or the evaluation will fail.</b> Spaces are allowed in the experssion 
